...
export default function LoginPage() {
  ...
  return (
    <>
      <Head>
        <title>Sign in — Stacklist</title>
        <meta name="description" content="Sign in to your Stacklist account to manage your tools and settings." />
      </Head>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-slate-500 mt-1">
              Sign in to your Stacklist account
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button type="button" className="inline-flex items-center justify-center gap-2 h-10 px-4 bg-white border border-slate-200 rounded-lg text-sm font-medium text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-all">
